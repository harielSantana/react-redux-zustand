    ...
    <div className="flex w-[1100px] flex-col gap-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-col gap-1">
          ...
          <span className="text-sm text-zinc-100">Modulo "Desvendando o Redux"</span>
        </div>
        ...
        <div className="flex-1">
          <div className="w-full bg-zinc-950 aspect-video">
            <ReactPlayer
              ...
              height="100%"
              controls
              url="https://youtu.be/ZnR12bQe_Y8"
            />
          </div>
        </div>
        <aside className="w-80 absolute top-0 bottom-0 right-0 border-l border-zinc-800 bg-zinc-900 divide-y-2 divide-zinc-900 overflow-y-scroll scrollbar scrollbar-thin scrollbar-track-zinc-950 scrollbar-thumb-zinc-950">
          <div>
